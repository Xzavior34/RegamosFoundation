  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-lg shadow-glow hover:shadow-glow",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-lg",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "gradient-gold text-accent-foreground font-semibold shadow-glow hover:shadow-glow hover:scale-105 rounded-lg",
        cta: "bg-accent text-accent-foreground font-semibold shadow-glow hover:bg-accent/90 hover:scale-105 rounded-lg",
      },
      size: {
